...
Payment allocation works as follows:

1. Calculate the interest due up to today's date.
2. If the payment amount is less than or equal to the interest due, the full payment is applied to interest.
3. If the payment is greater than the interest due, the interest is cleared first and the remaining amount is applied to the principal.
4. Payments greater than the total amount payable are rejected.
5. Once the outstanding principal becomes zero, the loan is automatically marked as **Closed**.
